      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item <?= ($data['judul'] === 'Data User') ? 'active' : '' ?>">
            <a href="<?= BASEURL;?>/admin/data_user" class="menu-link">
              <i class="menu-icon tf-icons bx bx-user-check"></i>
              <div data-i18n="Tables">Data User</div>
            </a>
          </li>
          <li class="menu-item <?= ($data['judul'] === 'Data Mentor') ? 'active' : '' ?>">
            <a href="<?= BASEURL;?>/admin/data_mentor" class="menu-link">
              <i class="menu-icon tf-icons bx bx-user-voice"></i>
              <div data-i18n="Tables">Mentor</div>
            </a>
          </li>
          <li class="menu-item <?= ($data['judul'] === 'Data Kelas') ? 'active' : '' ?>">
            <a href="<?= BASEURL;?>/admin/data_kelas" class="menu-link">
