...
<head>
    ...
    <title>Dashboard | Kelas Saya</title>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item ">
                        <a href="<?= BASEURL?>/dashboard" class="menu-link">
                            ...
                            <div data-i18n="Tables">Kembali ke Beranda</div>
                        </a>
                    </li>
                    <li class="menu-header small text-uppercase"><span class="menu-header-text"> akun anda</span>
                    </li>
                    <!-- Tables -->
                    <li class="menu-item <?= ($data['judul'] === 'Kelas Saya') ? 'active' : '' ?>">
                        <a href="<?= BASEURL?>/profile/kelas_saya" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-book"></i>
                            <div data-i18n="Tables">Kelas Saya</div>
                        </a>
                    </li>
                    <li class="menu-item <?= ($data['judul'] === 'Profile Saya') ? 'active' : '' ?>">
                    ...
                    <!-- Misc -->
                    <li class="menu-header small text-uppercase"><span class="menu-header-text">Help & Support</span>
                    </li>
                    <li class="menu-item">
                    ...
                    <li class="menu-header small text-uppercase"><span class="menu-header-text">Keluar dari akun</span>
                    </li>
                    <li class="menu-item">
                        <a href="<?= BASEURL;?>/auth/logout" class="menu-link">
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <div class="navbar-nav align-items-center">
                            <div class="nav-item d-flex align-items-center">
                                ...
                                <h5 class="fw-bold mt-3">Dashboard User / <?= $data['judul']?></h5>
                            </div>
                        </div>
                        <!-- /Search -->
